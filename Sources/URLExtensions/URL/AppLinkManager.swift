...
extension URL {
    static let appLinkManager = AppLinkManager.default()
    
    public final class AppLinkManager: @unchecked Sendable {
        ...
        /// Restore the default ``AppLink`` types
        public func restoreDefaults() {
            let defaults = AppLinkManager.default()
            lock.withLock {
                _types = defaults.types
            }
        }
        
        static func `default`() -> AppLinkManager {
            ...
            return AppLinkManager(types: defaultTypes + thirdPartyTypes)
        }
    }
}
